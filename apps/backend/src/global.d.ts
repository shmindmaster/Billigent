...
declare module "@azure/cosmos" {
  ...
  export type DatabaseResponse = any;
  export type ContainerResponse = any;
}
...
declare module "@azure/storage-file-datalake" {
  export class DataLakeServiceClient {
    static fromConnectionString(cs: string): DataLakeServiceClient;
    getFileSystemClient(name: string): any;
  }
  export type FileSystemItem = any;
}

declare module "@azure/search-documents" {
  export class SearchClient<T = any> {
    constructor(endpoint: string, index: string, credential: any);
    search(query: string, opts?: any): AsyncIterable<any>;
    uploadDocuments(docs: any[]): Promise<any>;
  }
