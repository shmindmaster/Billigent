              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="inline-flex items-center px-3 py-2 rounded-md text-sm bg-emerald-600 text-white hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                  >
